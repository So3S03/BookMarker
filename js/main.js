...
function showData() {
    ...
    for (let i = 0; i < dataArr.length; i++) {
        temp += `<tr>
                ...
                <td><button class="btn btn-info px-3 special-btn2" onclick="goToWebsite(${i})"><i
                    class="fa-solid fa-eye me-1"></i>
                    Visit</button></td>
                <td><button class="btn btn-danger px-3" onclick="del(${i})"><i class="fa-solid fa-trash-can me-1"></i>
                Delete</button>
        </td>
    </tr>`
    }
